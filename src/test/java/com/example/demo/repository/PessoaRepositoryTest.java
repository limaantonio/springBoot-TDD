...
public class PessoaRepositoryTest {
    ...
    public void nao_deve_encontrar_pessoa_de_cpf_inexistente() throws Exception {
        Optional<Pessoa> optional = sut.findByCpf("38767894100");
    ...
    public void nao_deve_encontrar_pessoa_cujo_ddd_e_telefone_nao_estejam_cadastrados() throws Exception{
        Optional<Pessoa> optional = sut.findByTelefoneDddAndTelefoneNumero("11", "350063312");
    ...
    @Test
    public void deve_filtra_pessoa_pelo_ddd_do_telefone()throws Exception {
        PessoaFiltro filtro = new PessoaFiltro();
        filtro.setDdd("21");
